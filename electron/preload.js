...
const exposedApi = {
  ...
  getTopStatus: (rootPath) => ipcRenderer.invoke("system:get-top-status", rootPath),
  openExternalUrl: (url) => ipcRenderer.invoke("system:open-external-url", url),
  confirmDiscardUnsaved: (count) => ipcRenderer.invoke("dialog:confirm-discard-unsaved", count),
